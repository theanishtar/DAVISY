...
public class DrawerDark implements DrawerController {

    public static DrawerDark newDrawer(JFrame fram) {
        return new DrawerDark(fram);
    }
    ...
    private Color drawerBackground = Color.BLACK;
    ...
    private DrawerDark(JFrame fram) {
        this.fram = fram;
    ...
    public DrawerDark header(Component component) {
        this.header = component;
        return this;
    }

    public DrawerDark addChild(Component... component) {
    ...
    public DrawerDark addFooter(Component... component) {
        for (Component com : component) {
            if (com instanceof DrawerItem) {
                DrawerItem item = (DrawerItem) com;
                item.setIndex(index++);
    ...
    public DrawerDark space(int height) {
    ...
    public DrawerDark separator(int height, Color color) {
        JLabel label = new JLabel();
        label.setPreferredSize(new Dimension(0, height));
    ...
    public DrawerDark background(Color color) {
        background = color;
        return this;
    }

    public DrawerDark drawerBackground(Color color) {
        drawerBackground = color;
        return this;
    }

    public DrawerDark drawerWidth(int drawerWidth) {
        this.drawerWidth = drawerWidth;
        return this;
    }

    public DrawerDark headerHeight(int headerHeight) {
        this.headerHeight = headerHeight;
        return this;
    }

    public DrawerDark backgroundTransparent(float backgroundTransparent) {
        this.backgroundTransparent = backgroundTransparent;
        return this;
    }

    public DrawerDark duration(int duration) {
        this.duration = duration;
        return this;
    }

    public DrawerDark resolution(int resolution) {
        this.resolution = resolution;
        return this;
    }

    public DrawerDark closeOnPress(boolean closeOnPress) {
        this.closeOnPress = closeOnPress;
        return this;
    }

    public DrawerDark leftDrawer(boolean leftDrawer) {
        this.leftDrawer = leftDrawer;
        return this;
    }

    public DrawerDark itemHeight(int itemHeight) {
        this.itemHeight = itemHeight;
        return this;
    }

    public DrawerDark enableScrollUI(boolean enableScrollUI) {
        this.enableScrollUI = enableScrollUI;
        return this;
    }

    public DrawerDark enableScroll(boolean enableScroll) {
        this.enableScroll = enableScroll;
        return this;
    }

    public DrawerDark itemAlignLeft(boolean itemAlignLeft) {
        this.itemAlignLeft = itemAlignLeft;
        return this;
    }

    public DrawerDark event(EventDrawer event) {
