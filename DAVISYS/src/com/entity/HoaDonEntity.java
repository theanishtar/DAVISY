...
public class HoaDonEntity {
    ...
    public HoaDonEntity(String maHD, String maKH, String tenDN, String maGH, String tenKH, String tenNV, Date ngayLap, int phanTramGG, float gia, float tongTien, float tienGiam, float thanhTien, boolean trangThai) {
        this.maHD = maHD;
        this.maKH = maKH;
        this.tenDN = tenDN;
        this.maGH = maGH;
