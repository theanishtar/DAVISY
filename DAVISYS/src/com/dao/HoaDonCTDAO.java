...
public class HoaDonCTDAO extends DAVISY<HoaDonCTEntity, String> {
    ...
    public List<HoaDonCTEntity> selectByIdSP(String key) {
        String SELECT_ALL="SELECT a.*,c.HOTEN,d.TENNV,c.TICHDIEM,b.PHANTRAMGG FROM CHITIETHOADON a,HOADON b ,KHACHHANG c ,TAIKHOAN d WHERE a.MAHD= b.MAHD AND b.MAKH=c.MAKH AND b.TENDN =d.TENDN AND a.MAHD = ?";
        return this.selectBySql(SELECT_ALL,key);
    }
