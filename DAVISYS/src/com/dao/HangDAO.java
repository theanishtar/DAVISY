...
public class HangDAO extends DAVISY<HangEntity, String> {
    ...
    final String INSERT_SQL = "INSERT INTO HANG (MAHANG, TEHANG) values(?, ?)";
    final String UPDATE_SQL = "UPDATE HANG SET TEHANG = ? WHERE MAHANG = ?";
    final String DELETE_SQL = "DELETE FROM HANG WHERE MAHANG = ?";
    final String SELECT_ALL_SQL = "SELECT * FROM MAHANG";
