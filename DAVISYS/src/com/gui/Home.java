    ...
    public void fillTableHoaDon() {
        ...
        try {
            for (HoaDonEntity hd : listHoaDon) {
                Object[] row = {hd.getMaHD(), hd.getNgayLap(), hd.getTongTien(), hd.getTichDiem(), hd.getPhanTramGG(), hd.getTienGiam(), (int) hd.getThanhTien(), hd.isTrangThai() ? "Đã thanh toán" : "Chưa thanh toán"};
                model.addRow(row);
            }
        } catch (Exception e) {
            MsgBox.alert(this, "Lỗi truy vấn dữ liệu!");
...
//Đi tới trang web hướng dẫn
    ...
    private void initComponents() {
        ...
        tblHoaDon.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã hóa đơn", "Ngày lập", "Tổng tiền", "Tích điểm", "Phần trăm giảm giá", "Tiền giảm", "Thành tiền", "Trạng thái"
            }
        ));
...
//            tblHoaDon.getValueAt(tblHoaDon.getSelectedRow(), 0);
    ...
    private void btnXoahdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoahdActionPerformed
        String trangThai = (String) tblHoaDon.getValueAt(this.row, 7);
