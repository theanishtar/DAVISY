...
INSERT INTO KHACHHANG VALUES
	(N'An', N'Nguyễn Văn An', '0123456789', N'Vĩnh Long', 0),
	(N'DinhPQ', N'Quốc Dinh', '0123456789', N'Cần Thơ', 0),
	(N'Quyen', N'Lâm Tố Quyên', '0123456789', N'Cần Thơ', 0),
	(N'Han', N'Đào Ngọc Hân', '0123456789', N'An Giang', 0),
	(N'Duyen', N'Trần Thị Mỹ Duyên', '0123456789', N'Cà Mau', 0)

INSERT INTO GIOHANG VALUES 
	(N'GH01', N'An', N'VinhPQ'),
	(N'GH02', N'DinhPQ', N'VinhPQ'),
	(N'GH03', N'Quyen', N'DanNK'),
	(N'GH04', N'Han', N'DanNK'),
	(N'GH05', N'Duyen', N'SyDH')
...
INSERT INTO HOADON VALUES
	(N'HD01', N'VinhPQ', N'An', N'GH01', CAST('6-10-2022' AS DATE), 120000, 0, 0 ,120000),
	(N'HD02', N'VinhPQ', N'DinhPQ', N'GH02', CAST('7-11-2022' AS DATE), 120000, 0, 0 ,120000),
	(N'HD03', N'DanNK', N'Quyen', N'GH03', CAST('7-11-2022' AS DATE), 120000, 0, 0 ,120000),
	(N'HD04', N'DanNK', N'Han', N'GH04', CAST('8-11-2022' AS DATE), 120000, 0, 0 ,120000),
	(N'HD05', N'SyDH', N'Duyen',N'GH05', CAST('9-11-2022' AS DATE), 120000, 0, 0 ,120000)


INSERT INTO CHITIETHOADON VALUES
	(N'CTHD01',N'HD01', N'SP02', 'SN', 'SDP', CAST('7-11-2022' AS DATE), N'Sạc dự phòng Sony', 'SONY', 'Sạc dự phòng', CAST('7-11-2022' AS DATE), 300000, 400000, 1),
	(N'CTHD02',N'HD01', N'SP01', 'AP', 'TN', CAST('6-10-2022' AS DATE), N'Tai nghe AirPod pro', 'APPLE', 'Tai nghe', CAST('7-10-2022' AS DATE), 1000000, 1200000, 1),
	(N'CTHD03',N'HD02', N'SP02', 'SN', 'SDP', CAST('7-11-2022' AS DATE), N'Sạc dự phòng Sony', 'SONY', 'Sạc dự phòng', CAST('7-11-2022' AS DATE), 300000, 400000, 1),
	(N'CTHD04',N'HD03', N'SP01', 'AP', 'TN', CAST('7-11-2022' AS DATE), N'Tai nghe AirPod pro', 'APPLE', 'Tai nghe', CAST('7-10-2022' AS DATE), 1000000, 1200000, 1),
	(N'CTHD05',N'HD04', N'SP04', 'LC', 'TSB', CAST('8-11-2022' AS DATE), N'Lót chuột in hình tùy chọn', 'TOSHIBA', 'Lót chuột', CAST('7-10-2022' AS DATE), 30000, 40000, 1),
	(N'CTHD06',N'HD05', N'SP01', 'AP', 'TN', CAST('9-11-2022' AS DATE), N'Tai nghe AirPod pro', 'APPLE', 'Tai nghe', CAST('7-10-2022' AS DATE), 1000000, 1200000, 2)
